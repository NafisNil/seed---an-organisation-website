...
<style>
    ...
    box-shadow: 0px 0px 10px 0px #FFC19F;
...
.ha-card-figure{
    border-radius:30px;
    box-shadow: 2px 2px 1px 1px #FFC19F;
}
                        ...
                        <div class="elementor-widget-container" >
                          <div class="ekit-wid-con">
                            <div class="ekit-heading elementskit-section-title-wraper text_left   ekit_heading_tablet-   ekit_heading_mobile-">
                              <h2 class="ekit-heading--title elementskit-section-title "  style="font-weight: 500 !important;">Team Member</h2>
