          ...
          <!-- left column -->
             <div class="card">
              <div class="card-header">
                ...
                <a href="{{route('focus.create')}}" class="float-right btn btn-outline-dark btn-sm mb-2"><i class="fas fa-plus-square"></i></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <td>
                      ...
                      <a href="{{route('focus.edit',[$item->id])}}" title="Edit"><button class="btn btn-outline-info btn-sm"><i class="fas fa-pen-square"></i></button></a>




                      <form action="{{route('focus.destroy',[$item->id])}}" method="POST">
